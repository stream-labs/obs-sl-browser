...
public:
	void start();
	void stop();
	void handleApiRequest(const std::string &funcName, const std::string &params, const int32_t peerPort, std::string* jsonOutput = nullptr);
	void pushApiRequest(const std::string &funcName, const std::string &params, const int32_t peerPort, std::string *jsonOutput = nullptr);
	void executeApiRequest(const std::string &funcName, const std::string &params, const int32_t peerPort, std::string *jsonOutput = nullptr);
