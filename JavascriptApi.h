...
public:
	...
	static std::map<std::string, std::pair<JSFuncs, JSSync>> &getPluginFunctionNames()
	{
		...
		static std::map<std::string, std::pair<JSFuncs, JSSync>> names =
		{
			/***
			* Docks
			*/
			...
			{"dock_queryAll",  {JS_QUERY_DOCKS, JS_SYNC}},

			// .(@function(arg1), @objectName, @url)
			//	Only works on docks we've created
			{"dock_setURL",  {JS_DOCK_SETURL, JS_SYNC}},

			// .(@function(arg1), @objectName, @jsString)
			//	Only works on docks we've created
			{"dock_executeJavascript",  {JS_DOCK_EXECUTEJAVASCRIPT, JS_SYNC}},

			// .(@function(arg1), @objectName, @bool_visible)
			{"dock_toggleDockVisibility",  {JS_TOGGLE_DOCK_VISIBILITY, JS_SYNC}},

			// Current release, OBS 29.1, does not have api support for destroying docks. Futurue releases will.
			// .(@objectName)
			//	Only works on docks we've created
			{"dock_destroyBrowserDock",  {JS_DESTROY_DOCK, JS_SYNC}},
			...
			{"dock_newBrowserDock",  {JS_DOCK_NEW_BROWSER_DOCK, JS_SYNC}},
			...
			{"dock_saveSlabsBrowserDocks",  {JS_SAVE_SL_BROWSER_DOCKS, JS_ASYNC}},
			...
			*/
			...
			{"qt_getMainWindowGeometry",  {JS_GET_MAIN_WINDOW_GEOMETRY, JS_SYNC}},
			...
			*/
			...
			{"win_toggleUserInput",  {JS_TOGGLE_USER_INPUT, JS_SYNC}},

			// .(@function(arg1))
			//	Launches a new OBS and terminates existing one at same time.
			{"win_restartOBS",  {JS_RESTART_OBS, JS_SYNC}},
			...
			*/
			...
			{"obs_source_create",  {JS_OBS_SOURCE_CREATE, JS_SYNC}},
			...
			{"obs_source_destroy",  {JS_OBS_SOURCE_DESTROY, JS_SYNC}},
			...
			{"obs_set_stream_settings",  {JS_SET_STREAMSETTINGS, JS_SYNC}},

			// .(@function(arg1))
			//	Returns json of service, protocol, server, bool_use_auth, username, password, key
			{"obs_get_stream_settings",  {JS_GET_STREAMSETTINGS, JS_SYNC}},

			// .(@function(arg1), @sceneName)
			//	Performs 'obs_frontend_set_current_scene' on the scene in question
			{"obs_set_current_scene",  {JS_SET_CURRENT_SCENE, JS_SYNC}},

			// .(@function(arg1))
			//		Example arg1 = { "name": "." }
			{"obs_get_current_scene",  {JS_GET_CURRENT_SCENE, JS_SYNC}},

			// .(@function(arg1), @sceneName)
			//	Peforms literally obs_scene_create(sceneName) 
			{"obs_create_scene",  {JS_CREATE_SCENE, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName)
			//	Peforms literally obs_scene_add(sceneName, sourceName)
			{"obs_scene_add",  {JS_SCENE_ADD, JS_SYNC}},

			// .(@function(arg1), @sceneName)
			//		Example arg1 = { "source_names": [] }
			{"obs_scene_get_sources",  {JS_SCENE_GET_SOURCES, JS_SYNC}},

			// .(@function(arg1))
			//	OBS_SOURCE_TYPE_INPUT = 0
			//	OBS_SOURCE_TYPE_FILTER = 1
			//		Example arg1 = [ { "name": ".",  {"type": 0, "id": "." , JS_SYNC}}, ... ]
			//
			//	Tansition/scene are sources yet may not be a part of obs_enum_sources
			//		OBS_SOURCE_TYPE_TRANSITION = 2
			//		OBS_SOURCE_TYPE_SCENE = 3
			{"obs_query_all_sources",  {JS_QUERY_ALL_SOURCES, JS_SYNC}},

			// .(@function(arg1))
			//		Example arg1 = [ { "name": ".",  {"type": 0, "id": "." , JS_SYNC}}, ... ]
			{"obs_enum_scenes",  {JS_ENUM_SCENES, JS_ASYNC}},

			// .(@function(arg1)
			//	Not yet implemented
			{"obs_source_get_properties_json",  {JS_SOURCE_GET_PROPERTIES, JS_SYNC}},

			// .(@function(arg1), @sourceName)
			//	Iterates the settings of a source and returns them as a json strong
			//		Example arg1 = <settings>
			{"obs_source_get_settings_json",  {JS_SOURCE_GET_SETTINGS, JS_SYNC}},

			// .(@function(arg1), @json_settings, @sourceName)
			//	Applies the json data into the source settings
			{"obs_source_set_settings_json",  {JS_SOURCE_SET_SETTINGS, JS_SYNC}},
			
			// .(@function(arg1))
			//		Example arg1 = [{ "name": "..." , JS_SYNC}},]
			{"obs_get_scene_collections",  {JS_GET_SCENE_COLLECTIONS, JS_SYNC}},

			// .(@function(arg1))
			//		Example arg1 = [{ "name": "..." }
			{"obs_get_current_scene_collection",  {JS_GET_CURRENT_SCENE_COLLECTION, JS_SYNC}},

			// .(@function(arg1), @sceneName)
			{"obs_set_current_scene_collection",  {JS_SET_CURRENT_SCENE_COLLECTION, JS_SYNC}},

			// .(@function(arg1), @sceneName)
			{"obs_add_scene_collection",  {JS_ADD_SCENE_COLLECTION, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName, @decimal_x, @decimal_y)
			{"obs_sceneitem_set_pos",  {JS_SET_SCENEITEM_POS, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName, @decimal_rot)
			{"obs_sceneitem_set_rot",  {JS_SET_SCENEITEM_ROT, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName, @int_left, @int_top, @int_right, @int_bottom)
			{"obs_sceneitem_set_crop",  {JS_SET_SCENEITEM_CROP, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName, @decimal_x, @decimal_y)
			{"obs_sceneitem_set_scale",  {JS_SET_SCALE, JS_SYNC}},
			...
			//	OBS_SCALE_LANCZOS = 5
			//	OBS_SCALE_AREA = 6
			{"obs_sceneitem_set_scale_filter",  {JS_SET_SCENEITEM_SCALE_FILTER, JS_SYNC}},
			...
			//	OBS_BLEND_LIGHTEN = 6
			//	OBS_BLEND_DARKEN = 7
			{"obs_sceneitem_set_blending_mode",  {JS_SET_SCENEITEM_BLENDING_MODE, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName, @int_blendingMethod)
			//	OBS_BLEND_METHOD_DEFAULT = 1
			//	OBS_BLEND_METHOD_SRGB_OFF = 2
			{"obs_sceneitem_set_blending_method",  {JS_SET_SCENEITEM_BLENDING_METHOD, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName)
			//		Example arg1 = { "x": 0.0, "y": 0.0 }
			{"obs_sceneitem_get_pos",  {JS_GET_SCENEITEM_POS, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName)
			//		Example arg1 = { "rotation": 0.0 }
			{"obs_sceneitem_get_rot",  {JS_GET_SCENEITEM_ROT, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName)
			//		Example arg1 = { "left": 0.0, "right": 0.0, "top": 0.0, "bottom": 0.0 }
			{"obs_sceneitem_get_crop",  {JS_GET_SCENEITEM_CROP, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName)
			//		Example arg1 = { "x": 0.0, "y": 0.0 }
			{"obs_sceneitem_get_scale",  {JS_GET_SCALE, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName)
			//		Example arg1 = { "scale_filter": 0 }
			{"obs_sceneitem_get_scale_filter",  {JS_GET_SCENEITEM_SCALE_FILTER, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName)
			//		Example arg1 = { "blending_mode": 0 }
			{"obs_sceneitem_get_blending_mode",  {JS_GET_SCENEITEM_BLENDING_MODE, JS_SYNC}},

			// .(@function(arg1), @sceneName, @sourceName)
			//		Example arg1 = { "blending_method": 0 }
			{"obs_sceneitem_get_blending_method",  {JS_GET_SCENEITEM_BLENDING_METHOD, JS_SYNC}},

			// .(@function(arg1), @sourceName)
			//		Example arg1 = { "width": 0, "height": 0 }
			{"obs_source_get_dimensions",  {JS_GET_SOURCE_DIMENSIONS, JS_SYNC}},

			// .(@function(arg1))
			//		Example arg1 = { "width": 0, "height": 0 }
			{"obs_canvas_get_dimensions",  {JS_GET_CANVAS_DIMENSIONS, JS_SYNC}},

			// .(@function(arg1))
			{"obs_bring_front",  {JS_OBS_BRING_FRONT, JS_SYNC}},

			// .(@function(arg1), @bool_hide)
			{"obs_toggle_hide_self",  {JS_OBS_TOGGLE_HIDE_SELF, JS_SYNC}},

			// .(@function(arg1), @id, @sourceName)
			//	@id must be correct or application will crash, ie "swipe_transition" is one example
			{"obs_add_transition",  {JS_OBS_ADD_TRANSITION, JS_SYNC}},

			// .(@function(arg1), @sourceName)
			{"obs_set_current_transition",  {JS_OBS_SET_CURRENT_TRANSITION, JS_SYNC}},

			// .(@function(arg1), @sourceName)
			{"obs_remove_transition",  {JS_OBS_REMOVE_TRANSITION, JS_SYNC}},

			// .(@function(arg1), @sourceName)
			//	Iterates the settings of a source and returns them as a json strong
			//		Example arg1 = <settings>
			{"obs_transition_get_settings_json",  {JS_TRANSITION_GET_SETTINGS, JS_SYNC}},

			// .(@function(arg1), @json_settings, @sourceName)
			//	Applies the json data into the source settings
			{"obs_transition_set_settings_json",  {JS_TRANSITION_SET_SETTINGS, JS_SYNC}},

			// .(@function(arg1))
			//	Returns the boolean value of the named obs function
			//		Example arg1 = { "value": true }
			{"obs_frontend_streaming_active",  {JS_GET_IS_OBS_STREAMING, JS_SYNC}},
			...
			*/
			...
			{"web_startServer",  {JS_START_WEBSERVER, JS_ASYNC}},

			// .(@function(arg1))
			//	Stops the webserver
			{"web_stopServer",  {JS_STOP_WEBSERVER, JS_ASYNC}},
			...
			{"web_launchOSBrowserUrl",  {JS_LAUNCH_OS_BROWSER_URL, JS_ASYNC}},

			// .(@function(arg1))
			//		Example arg1 = { "token": "." }
			{"web_getAuthToken",  {JS_GET_AUTH_TOKEN, JS_SYNC}},

			// .(@function(arg1))
			{"web_clearAuthToken",  {JS_CLEAR_AUTH_TOKEN, JS_SYNC}},
			...
			*/
			...
			{"sl_getVersionInfo",  {JS_SL_VERSION_INFO, JS_SYNC}},
	...
	static std::map<std::string, std::pair<JSFuncs, JSSync>> &getBrowserFunctionNames()
	{
		// None of the api function belows are blocking, they return immediatelly, but can accept a function as arg1 thats invoked when work is complete, which should allow await/promise structure
		static std::map<std::string, std::pair<JSFuncs, JSSync>> names =
		{
			...
			*/
			...
			// .(@function(arg1), x, y)`
			{"qt_resizeBrowser",  {JS_QT_RESIZE_BROWSER, JS_ASYNC}},

			// .(@function(arg1))`
			{"qt_bringToFront",  {JS_QT_BRING_FRONT, JS_ASYNC}},

			// .(@function(arg1), x, y)`
			{"qt_setWindowPosition",  {JS_QT_SET_WINDOW_POSITION, JS_ASYNC}},

			// .(@function(arg1), x, y)`
			{"qt_setAllowHideBrowser",  {JS_QT_SET_ALLOW_HIDE_BROWSER, JS_ASYNC}},
		};
	...
	static JSSync getFunctionSyncType(const std::string &funcName)
	{
		auto ref = getPluginFunctionNames();
		auto itr = ref.find(funcName);
